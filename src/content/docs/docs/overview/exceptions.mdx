...
jika kamu memakai `autoComposeExceptionHandler` maka exception handler akan otomatis di register kedalam sistem secara global dengan persyaratan harus berada di dalam folder `exceptions/**`.

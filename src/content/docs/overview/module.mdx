...
<Aside type="tip">
  you can use the CLI's Module maker:

  This will create 3 files, Block, Routes and Service

  <PackageManagers pkgManagers={["npm", "pnpm", "yarn", "bun"]} type="exec" args="gaman make:module <name>"/>
</Aside>
